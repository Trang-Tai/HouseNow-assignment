...
export const CreateTodoForm = () => {
  ...
  return (
    <form className="group flex items-center justify-between gap-2 rounded-12 border border-gray-200 py-2 pl-4 pr-3 focus-within:border-gray-400">
      ...
      <input
        ...
        className="flex-1 text-base placeholder:text-gray-400 focus:outline-none"
